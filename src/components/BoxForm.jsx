            ...
            <div className='col'></div>
                ...
                <form onSubmit={ handleSubmit }>
                    <div className='mb-3' >
                      ...
                      <input className='form-control' type="text" onChange={ (e) => setColorBox(e.target.value)} value={colorBox} />
                      <label className='form-label'>Color size: </label> 
                      <input className='form-control' type='text' onChange={ (e) => setBoxSize(e.target.value)} value = {boxSize} />
